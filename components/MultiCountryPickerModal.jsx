...
export default function MultiCountryPickerModal({
  visible,
  onClose,
  onSelect,
  selectedCountries = [],
  ...
  const isCountrySelected = (country) => {
    return selectedCountries.some(
      (selected) => selected.code === country.cca2 || selected.name === country.name.common
    );
  };
  ...
  const handleToggleCountry = (country) => {
    ...
    if (isSelected) {
      ...
      // Add country
      newSelectedCountries = [...selectedCountries, countryData];
    }

    onSelect(newSelectedCountries);
  };
      ...
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContainer, { height: modalHeight }]}>
          ...
          {selectedCountries.length > 0 && (
            <View style={{ paddingHorizontal: 20, paddingVertical: 10, backgroundColor: COLORS.primary + "10" }}>
